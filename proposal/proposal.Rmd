...
@eman:2016 propose using visual and textual features to predict the house price. Then, these extracted features are passed through a neural network model. Through experiments the visual features increased the performance.  Different 11 machine learning regression models are used by @park:2015 and evaluated to determine the best model for a better house price prediction of the capital Islamabad. @alfiyatin:2017 rely on three factors: physical conditions, concept, and location to predict the price of a house. Linear regression and particle swarm optimization methods are leveraged to predict the house price
